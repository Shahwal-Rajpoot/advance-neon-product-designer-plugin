		...
		if ( $anpd_font_group ) :
			foreach ( $anpd_font_group as $field ) {
				...
				<tr>
					...
					<td><input type="number" style="width:98%;" name="font_price[]" value="<?php if ($field['font_price'] != '') echo esc_attr( $field['font_price'] ); ?>" placeholder="Price" min="0" step="0.01"/></td>
			...
			<tr>
				...
				<td><input type="number" style="width:98%;" name="font_price[]" placeholder="Price" min="0" step="0.01"/></td>
