		...
		if ( $anpd_size_group ) :
			foreach ( $anpd_size_group as $field ) {
				...
				<tr>
					...
					<td><input type="number" style="width:98%;" name="size_price[]" value="<?php if ($field['size_price'] != '') echo esc_attr( $field['size_price'] ); ?>" placeholder="Price" step="0.01"/></td>
			...
			<tr>
				...
				<td><input type="number" style="width:98%;" name="size_price[]" placeholder="Price" step="0.01"/></td>
