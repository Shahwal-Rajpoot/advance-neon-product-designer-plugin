		...
		if ( $anpd_color_group ) :
			foreach ( $anpd_color_group as $field ) {
				...
				<tr>
					...
					<td><input type="number" style="width:98%;" name="price[]" value="<?php if ($field['price'] != '') echo esc_attr( $field['price'] ); ?>" placeholder="Price" min="0.01" step="0.01"/></td>
			...
			<tr>
				...
				<td><input type="number" style="width:98%;" name="price[]" placeholder="Price" min="0.01" step="0.01"/></td>
